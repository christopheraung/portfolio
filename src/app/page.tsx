...
.company-header>div>div:first-child{
...
.company-header span[style*="font-size:12px"]{
...
/* Phase tags */
.phase1{background:#e6edf5;color:#667085}
.phase2{background:#edf2e7;color:#667085}
.phase3{background:#efeff8;color:#667085}
.phase4{background:#f5efe5;color:#667085}
.phase5{background:#f6e9e7;color:#667085}
...
/* Analytical write-up paragraphs */
.annual-note,
.volatility-note{
  max-width:720px;
...
<h2 class=\"sr-only\">Interactive AI adoption and stock performance dashboard for DBS, OCBC, UOB and SGX</h2>

<div style=\"padding:1rem 0 0\">

<div class=\"tabs\" id=\"tabs\">
  <button class=\"tab active\" onclick=\"showPanel('dbs',this)\">DBS (D05.SI)</button>
  <button class=\"tab\" onclick=\"showPanel('ocbc',this)\">OCBC (O39.SI)</button>
  <button class=\"tab\" onclick=\"showPanel('uob',this)\">UOB (U11.SI)</button>
  <button class=\"tab\" onclick=\"showPanel('sgx',this)\">SGX (S68.SI)</button>
</div>

<div id=\"dbs\" class=\"panel active\"></div>
<div id=\"ocbc\" class=\"panel\"></div>
<div id=\"uob\" class=\"panel\"></div>
<div id=\"sgx\" class=\"panel\"></div>
</div>
...
const COMPANIES = {
  dbs: {
    ...
    ticker:\"D05.SI\",
    badge:\"dbs-badge\",
    badgeLabel:\"Bank · SGX:D05\",
    sector:\"Commercial banking\",
    mktcap:\"S$181B\",
    listed:\"1999\",
    ath:\"S$65.05 (Jun 2026)\",
    atl:\"S$2.94 (Mar 2009)\",
    current:\"S$63.78\",
    yearReturn:\"+43.5% (1yr)\",
    chartColor:\"#378ADD\",
    annualNote:\"DBS shows the clearest correlation — its 2017–2018 AI industrialisation push coincides with a +47.9% year in 2017 and the beginning of a sustained re-rating. The stock has nearly tripled from S$20 in 2017 to over S$63 today. The 2024 AI value disclosure of SGD 780M aligns with a +53.2% year.\",
    volatilityNote:\"DBS’ volatility profile appears to compress after the early AI industrialisation phase. This suggests that larger and more systematic AI investment may have helped convert technology uncertainty into operating leverage, with model governance, customer analytics, and measurable AI value disclosures reducing the perceived complexity of the bank’s earnings story.\",
    milestones:[
      {year:2014,phase:1,phaseClass:\"phase1\",text:\"'Digital to the core' strategy declared by CEO Piyush Gupta; first AI/ML experiments begin with IBM and A*STAR partnerships\"},
      {year:2018,phase:2,phaseClass:\"phase2\",text:\"AI Industrialisation Programme launched — the key scale-up inflection. Proprietary ADA (data governance platform) and ALAN (AI protocol, named after Alan Turing) built in-house; PURE ethics framework adopted. First model took 15 months; ALAN cuts that to 2 months.\"},
      {year:2019,phase:3,phaseClass:\"phase3\",text:\"100+ ML models deployed across 'Intelligent Banking' for 5M+ customers; NLP personalisation at scale begins; Veritas Initiative (MAS) co-developed\"},
      {year:2021,phase:3,phaseClass:\"phase3\",text:\"Began formally quantifying and disclosing economic value of AI; SGD 180M in AI value reported for 2022\"},
      {year:2022,phase:4,phaseClass:\"phase4\",text:\"SGD 180M economic value from AI/ML (SGD 150M revenue uplift + SGD 30M cost savings); 370 use cases building\"},
      {year:2023,phase:4,phaseClass:\"phase4\",text:\"GenAI phase (AI 3.0) begins; proprietary LLM framework built; Harvard Business School publishes first Asian-bank AI case study on DBS; ranked #1 in Global Evident AI Index (Asia)\"},
      {year:2024,phase:5,phaseClass:\"phase5\",text:\"SGD 750–780M AI economic value; 1,500 models; 370+ use cases; ADA holds 5.3 petabytes of data; Google Cloud Vertex AI integration\"},
      {year:2025,phase:5,phaseClass:\"phase5\",text:\"~SGD 1 billion AI value milestone; 2,000+ models; 430+ use cases; GenAI marketplace with LLM-as-a-service launched\"}
    ],
    annual:{
      2000:-27.16,2001:-28.11,2002:-18.42,2003:37.83,2004:12.04,
      2006:41.27,2007:-6.07,2008:-57.06,2009:84.59,2010:-4.53,
      2011:-17.46,2012:31.86,2013:19.46,2014:24.55,2015:-16.20,
      2016:10.85,2017:47.87,2018:-1.92,2019:15.50,2020:1.52,
      2021:33.23,2022:7.96,2023:4.15,2024:53.24,2025:34.16,2026:13.17
    },
    aiEvents:{2014:\"AI begins\",2018:\"AI scale-up\",2019:\"100+ models\",2022:\"SGD 180M value\",2024:\"SGD 780M value\",2025:\"SGD 1B milestone\"}
  },
  ocbc:{
    name:\"OCBC Bank\",
    ticker:\"O39.SI\",
    badge:\"ocbc-badge\",
    badgeLabel:\"Bank · SGX:O39\",
    sector:\"Commercial banking, insurance (Great Eastern), wealth\",
    mktcap:\"S$104B\",
    listed:\"1932\",
    ath:\"S$24.68 (Jun 2026)\",
    atl:\"S$0.87 (Mar 2003)\",
    current:\"S$23.94\",
    yearReturn:\"+41.7% (1yr)\",
    chartColor:\"#639922\",
    annualNote:\"OCBC launched its AI unit in 2018, the same year the stock fell 8.9%, but it has compounded strongly since — up +54.8% in 2017, and more recently +33.3% in 2024 and +32.7% in 2025 as AI-driven revenue gains became visible.\",
    volatilityNote:\"OCBC’s volatility decline is more gradual. The bank’s AI unit, NLP credit tools, OCBC GPT deployment, and daily decision automation indicate a progressive shift from experimentation to embedded operating infrastructure, which plausibly lowers uncertainty around execution risk as AI becomes absorbed into ordinary banking processes.\",
    milestones:[
      {year:1999,phase:1,phaseClass:\"phase1\",text:\"Data science journey begins (stated by Group Data Office head Donald MacDonald in public interview)\"},
      {year:2018,phase:2,phaseClass:\"phase2\",text:\"Established dedicated AI unit — first bank in Singapore and Asia to do so; now known as the Group Data Office. Built customer service chatbot and internal HR chatbot 'Buddy'; launched AI postgraduate scholarship programme\"},
      {year:2019,phase:3,phaseClass:\"phase3\",text:\"First-generation NLP LLMs adopted (BERT, FinBERT) to read news, identify bonds at risk of default, credit early warning signals, and make stock recommendations. On-premise GPU clusters built; mature MLOps practice established\"},
      {year:2022,phase:4,phaseClass:\"phase4\",text:\"AI powering 4–6 million decisions per day across credit, fraud detection, and personalisation; data platforms modernised for GenAI readiness\"},
      {year:2023,phase:4,phaseClass:\"phase4\",text:\"November 2023: OCBC GPT launched — first bank in Singapore to roll out a GenAI chatbot for all 30,000 employees worldwide (writing, research, ideation)\"},
      {year:2024,phase:5,phaseClass:\"phase5\",text:\"Annual Report 2024: AI embedded in fraud detection, credit card personalisation, daily risk operations; GenAI powering productivity across 30 offices globally; quantum computing partnerships initiated\"},
      {year:2025,phase:5,phaseClass:\"phase5\",text:\"Partnership with Accenture for GenAI and agentic AI acceleration; AI model exceeds S$100B market cap milestone; world's Best Bank recognition maintained\"}
    ],
    annual:{
      2000:-20.78,2001:-19.06,2002:-6.21,2003:32.01,2004:19.14,
      2006:26.88,2007:17.32,2008:-37.17,2009:89.94,2010:24.37,
      2011:-20.34,2012:34.89,2013:3.12,2014:4.91,2015:-18.80,
      2016:5.48,2017:54.75,2018:-8.92,2019:2.74,2020:-1.03,
      2021:14.03,2022:12.22,2023:14.97,2024:33.31,2025:32.69,2026:12.39
    },
    aiEvents:{1999:\"Data science starts\",2018:\"AI unit (1st in Asia)\",2019:\"BERT/FinBERT NLP live\",2023:\"OCBC GPT launch\",2025:\"GenAI/agentic AI\"}
  },
  uob:{
    name:\"United Overseas Bank\",
    ticker:\"U11.SI\",
    badge:\"uob-badge\",
    badgeLabel:\"Bank · SGX:U11\",
    sector:\"Commercial banking, asset management, venture capital\",
    mktcap:\"S$62B\",
    listed:\"1935\",
    ath:\"S$39.50 (Jan 2026)\",
    atl:\"S$3.64 (May 2000)\",
    current:\"S$37.75\",
    yearReturn:\"+9.5% (1yr)\",
    chartColor:\"#7F77DD\",
    annualNote:\"UOB deployed its AML-AI solution in 2020, a down year of −10.8% because of COVID-related market stress. However, the AI-enhanced ASEAN expansion through the Citi acquisition and TMRW platform helped fuel a +35.0% return in 2024.\",
    volatilityNote:\"UOB’s volatility pattern is consistent with a more defensive AI adoption path. AI was first concentrated in AML, compliance, and risk-screening architecture, so the market signal is less about immediate revenue acceleration and more about operational resilience, regional integration, and reduced downside uncertainty after the ASEAN expansion phase.\",
    milestones:[
      {year:2018,phase:2,phaseClass:\"phase2\",text:\"AML proof of concept initiated — partnered with RegTech firm Tookitaki to integrate ML into anti-money laundering (transaction monitoring and name screening); first such ML-AML integration in Singapore\"},
      {year:2020,phase:3,phaseClass:\"phase3\",text:\"Full deployment of Tookitaki AMLS AI-powered AML suite: first in APAC to run complete AI-AML concurrently across two risk dimensions. 96% true positive rate in high-priority category; screening 60,000 account names monthly\"},
      {year:2021,phase:3,phaseClass:\"phase3\",text:\"ICT spend ~US$475M/year; enterprise-wide big data platform deployed; TMRW — AI-driven hyper-personalised digital bank for ASEAN — launched; investment in cloud, AI, and RPA at scale\"},
      {year:2022,phase:4,phaseClass:\"phase4\",text:\"Citi consumer banking acquisition (ASEAN) — data and AI assets integrated; big data analytics underpins expanded Southeast Asian customer base\"},
      {year:2023,phase:4,phaseClass:\"phase4\",text:\"Staff-facing AI productivity copilots piloted; NLP for document review and compliance workflows deployed\"},
      {year:2025,phase:5,phaseClass:\"phase5\",text:\"Strategic partnership with Accenture for GenAI and agentic AI acceleration; partnership with Enterprise Singapore for AI-enabled F&B SME solutions; AI workforce upskilling programme launched\"}
    ],
    annual:{
      2000:-13.57,2001:1.24,2002:-4.51,2003:13.56,2004:9.25,
      2006:37.00,2007:5.37,2008:-32.26,2009:53.00,2010:-4.45,
      2011:-15.08,2012:31.46,2013:9.67,2014:19.31,2015:-16.94,
      2016:10.99,2017:33.63,2018:-4.60,2019:11.83,2020:-10.84,
      2021:23.14,2022:18.85,2023:-2.09,2024:35.01,2025:0.82,2026:6.36
    },
    aiEvents:{2018:\"ML-AML PoC starts\",2020:\"Full AMLS deployment\",2021:\"TMRW AI bank\",2022:\"Citi acquisition\",2025:\"GenAI partnership\"}
  },
  sgx:{
    name:\"Singapore Exchange\",
    ticker:\"S68.SI\",
    badge:\"sgx-badge\",
    badgeLabel:\"Exchange · SGX:S68\",
    sector:\"Securities & derivatives exchange, clearing, market data, FX\",
    mktcap:\"S$24B\",
    listed:\"2000\",
    ath:\"S$22.50 (May 2026)\",
    atl:\"S$0.19 (Sep 2001)\",
    current:\"S$21.74\",
    yearReturn:\"+54.6% (1yr)\",
    chartColor:\"#BA7517\",
    annualNote:\"SGX is distinctly different — its 2006–2007 run of +119% and +148% was driven by the global equity boom, not AI. Its post-2020 AI surveillance and MaxxAI deployment tracks alongside steadier but consistent gains: +30% in 2024, +46% in 2025, and +27.5% so far in 2026 with record earnings reported.\",
    volatilityNote:\"SGX’s volatility compression is best read through market-infrastructure complexity. AI surveillance, MaxxAI, FX data analytics, and automated institutional reporting add value by improving market integrity and data monetisation, but the effect is steadier because exchange earnings remain tied to trading volumes, listings, and derivatives-cycle conditions.\",
    milestones:[
      {year:2000,phase:1,phaseClass:\"phase1\",text:\"SGX listed on own exchange (Nov 2000); SGX formed in 1999 from merger of Stock Exchange of Singapore and SIMEX; early algorithmic infrastructure begins\"},
      {year:2012,phase:1,phaseClass:\"phase1\",text:\"SGX Reach ultra-low-latency trading engine deployed; randomisation algorithm introduced in opening/closing auctions to prevent order rigging; HFT makes up 30% of derivatives volume by this era\"},
      {year:2016,phase:2,phaseClass:\"phase2\",text:\"Accelerated push for global algorithmic traders; co-location and data hub services expanded; NASDAQ OMX technology platform adopted for securities trading\"},
      {year:2020,phase:3,phaseClass:\"phase3\",text:\"SGX RegCo deploys AI-powered market surveillance: ML learns historical trading patterns, isolates manipulative activity, generates higher-quality regulatory alerts. Anomaly detection for latency monitoring. NLP engine for corporate announcements. Automated PDF classification\"},
      {year:2022,phase:4,phaseClass:\"phase4\",text:\"SGX FX data team begins building MaxxAI: ML-powered tool for curating FX pricing, trade data, and automatic insight generation for institutional clients\"},
      {year:2023,phase:4,phaseClass:\"phase4\",text:\"MaxxAI deployed to institutional clients; ML establishes cause-and-effect relationships in trading behaviour, reducing analysis time significantly; SGX FX OTC volume surpasses $111bn ADV\"},
      {year:2024,phase:5,phaseClass:\"phase5\",text:\"MaxxAI wins WatersTechnology Asia Award for Best AI-Based Solution 2024; SGX FX AI/data team provides automated daily performance reports to traders; crypto perpetual futures launched\"},
      {year:2025,phase:5,phaseClass:\"phase5\",text:\"Highest annual earnings since 2000 listing reported; record volumes driven partly by AI-enabled electronic trading expansion; FX integration with CME Group announced; SGX hits record high S$22.50\"}
    ],
    annual:{
      2000:-1.70,2001:-4.57,2002:12.14,2003:47.07,2004:14.75,
      2006:118.76,2007:147.62,2008:-58.92,2009:69.67,2010:13.99,
      2011:-26.48,2012:24.84,2013:2.88,2014:6.78,2015:-3.21,
      2016:-2.72,2017:17.19,2018:-2.18,2019:29.98,2020:10.92,
      2021:-3.26,2022:-0.89,2023:16.61,2024:30.68,2025:46.06,2026:27.52
    },
    aiEvents:{2012:\"SGX Reach engine\",2016:\"Algo trading push\",2020:\"AI surveillance live\",2022:\"MaxxAI dev begins\",2024:\"MaxxAI award\",2025:\"Record earnings\"}
  }
};

const PHASE_LABELS={1:\"Algo foundations (pre-2016)\",2:\"AI labs & governance (2016–2018)\",3:\"National strategy & scale (2019–2021)\",4:\"NLP / GenAI pilots (2022–2023)\",5:\"Full GenAI deployment (2024–2026)\"};
const PHASE_COLORS={1:\"#B5D4F4\",2:\"#5DCAA5\",3:\"#AFA9EC\",4:\"#FAC775\",5:\"#F09595\"};
let charts={};
...
function buildPanel(key){
  ...
  const years=Object.keys(c.annual).map(Number).filter(y=>y>=2017&&y<=2026).sort((a,b)=>a-b);
  const vals=years.map(y=>c.annual[y]);

  const aiYears=Object.keys(c.aiEvents).map(Number);

  let yearCells=years.map(y=>{
    const v=c.annual[y];
    const cls=v>=0?'pos':'neg';
    const sign=v>=0?'+':'';
    const hasAI=aiYears.includes(y);
    return \`<div class=\"yr-cell\"><div class=\"y\">\${y}\${hasAI?' ★':''}</div><div class=\"v \${cls}\">\${sign}\${v.toFixed(1)}%</div></div>\`;
  }).join('');

  let tlHtml=c.milestones.filter(m=>m.year>=2017&&m.year<=2026).map(m=>\`
    <div class=\"tl-entry\">
      <div class=\"tl-yr\">\${m.year}</div>
      <div class=\"tl-dot\" style=\"background:\${PHASE_COLORS[m.phase]}\"></div>
      <div class=\"tl-body\">\${m.text}<span class=\"tl-tag \${m.phaseClass}\">\${PHASE_LABELS[m.phase]}</span></div>
    </div>\`).join('');

  el.innerHTML=\`
    <div class=\"company-header\">
      <div>
        <div style=\"font-size:18px;font-weight:500;color:var(--color-text-primary);margin-bottom:4px\">\${c.name}</div>
        <span class=\"ticker-badge \${c.badge}\">\${c.badgeLabel}</span>
        <span style=\"font-size:12px;color:var(--color-text-secondary);margin-left:8px\">\${c.sector}</span>
      </div>
    </div>
    <div class="stat-grid">
      <div class="stat-card"><div class="stat-label">Current price</div><div class="stat-value">\${c.current}</div><div class="stat-sub">\${c.yearReturn}</div></div>
      <div class="stat-card"><div class="stat-label">Marketcap</div><div class="stat-value">\${c.mktcap}</div><div class="stat-sub">SGX listed \${c.listed}</div></div>
      <div class="stat-card"><div class="stat-label">Highest</div><div class="stat-value">\${c.ath.split(' (')[0]}</div><div class="stat-sub">\${(c.ath.match(/\((.*?)\)/)||['',''])[1]}</div></div>
    </div>

    <div class="section-title">Annual Stock Performance (%) <span class="section-sub">★ Marks AI Adoption Years</span></div>
    <div class=\"year-grid\">\${yearCells}</div>
    <p class=\"annual-note\">\${c.annualNote}</p>

    <div class=\"section-title\">Performance chart</div>
    <div style=\"height:200px;margin-bottom:1.5rem\"><canvas id=\"chart-\${key}\"></canvas></div>

    <div class=\"section-title\">AI adoption timeline</div>
    <div class=\"timeline\">\${tlHtml}</div>
    <p class=\"volatility-note\">\${c.volatilityNote}</p>
  \`;
  ...
  requestAnimationFrame(()=>{
    ...
    const bgColors=vals.map(v=>v>=0?'rgba(99,153,34,0.75)':'rgba(163,45,45,0.75)');
    const borderColors=vals.map(v=>v>=0?'#3B6D11':'#791F1F');
    ...
    aiYears.forEach((y,i)=>{
      ...
      if(idx>=0){
        annotations[\`ai\${i}\`]={
          ...
          borderWidth:1,
          borderDash:[3,3],
          label:{content:c.aiEvents[y],display:true,position:'start',font:{size:9},color:'var(--color-text-secondary)',backgroundColor:'transparent',padding:2}
        };
      }
    });
    ...
    charts[key]=new Chart(ctx,{
      ...
      options:{
        ...
        plugins:{
          ...
          tooltip:{callbacks:{label:ctx=>{const v=ctx.parsed.y;return (v>=0?'+':'')+v.toFixed(2)+'%'}}}
        },
        scales:{
          x:{ticks:{font:{size:9},maxRotation:45},grid:{display:false}},
          y:{ticks:{font:{size:9},callback:v=>(v>=0?'+':'')+v+'%'},grid:{color:'var(--color-border-tertiary)'}}
        }
      }
    });
  });
...
Object.keys(COMPANIES).forEach(buildPanel);
</script>
`;
const NAV_ITEMS = [
                  ...
                  <details className="group py-5">
                    <summary className="cursor-pointer list-none [&::-webkit-details-marker]:hidden">
                      <div className="flex items-start justify-between">
                        <div>
                          <h3 className="text-[15px] font-semibold leading-snug text-[#1a1f2b]">
                            AI powered Revaluations in Singapore's Commercial Banks
                          </h3>
                        </div>
                    ...
                    <div className="mt-6 origin-top opacity-0 -translate-y-2 scale-y-[0.985] transition-all duration-700 ease-out group-open:opacity-100 group-open:translate-y-0 group-open:scale-y-100">
                                ...
                                <p className="text-justify text-[8px] leading-relaxed text-gray-600">
                                  Overviewing stock prices of Singapore's largest commercial banks, Yahoo Finance. Output: Author 
                                </p>
                      <p className="mb-5 max-w-4xl text-justify text-[12.5px] leading-relaxed text-gray-600">

Rapid appreciation of Singapore's commercial banking landscape following 2024 reflected a broader market revaluation of artificial intelligence and digitalisation capabilities among the largest banks. While rising interest rates did contribute to record level profits, the observed persistence in share price gains suggest investors have viewed banks to increasingly be institutions which materialise the much touted gains of technology enabled productivity. The shift was most prominent through DBS which disclosed its AI and data initiatives generated approximately SGD 780 million in economic value during 2024. This was a great testimony on being the first large scale demonstration that AI could contribute directly to earnings rather than remain an experimental investment or merely a supplementing or supporting wing in operations. Similar digital transformation strategies were subsequently reflected across OCBC and UOB as well, while in comparison equity applications summarised by SGX valuation has seen lesser but still significant increments. While banks see immediate improvements in operation automation, advanced analytics, compliance optimisation, and customer intelligence, this additional valuation has also interestingly resulted in much more stable variability in stock prices of financial institutions in commercial banking. 
                      </p>
                      ...
                      <div className="w-full bg-transparent">
                        <iframe
                          loading="lazy"
                          srcDoc={AI_DASHBOARD_HTML}
                          title="AI adoption and Singapore financial equity revaluation dashboard"
                          className="h-[1180px] w-full border-0 bg-transparent"
                        />
                      </div>
