...
>
        ...
        <nav className="w-44 bg-[#1b1e27] border-r border-gray-700 text-gray-300 pl-9 pr-4 py-55 fixed top-0 left-0 h-full">
          <ul className="space-y-5 text-[15px] tracking-wide mt-12">
            ...
            <li><a href="/#Lectures" className="hover:text-white transition-colors">Lectures</a></li>
          </ul>
        </nav>

        {/* LEFT PANEL - LOGIN FORM */}
        <div className="flex flex-col justify-center w-full md:w-1/2 bg-[#1a1f2b] text-white px-16 py-16 ml-44 mt-[56px]">
          <div className="mb-12">
            <h1 className="text-2xl font-lora tracking-wide text-steel-200 mb-1">Industry Clients</h1>
            <p className="text-sm text-gray-400 uppercase tracking-wide">Quantitative Analytics</p>
          </div>

          <h2 className="text-4xl font-bold mb-3 font-lora leading-snug">Welcome Back</h2>
          <p className="text-gray-400 mb-10 text-[14px]">Log in to access your portfolio.</p>
          ...
          <form className="space-y-8 max-w-sm">
            ...
            <button type="submit" className="bg-steel-700 hover:bg-steel-500 text-white text-[14px] font-medium py-3 px-6 rounded-md transition-colors w-auto">
              Log In
            </button>

            <div className="text-[12px] mt-6 space-y-2">
              <a href="mailto:mhaung.2021@mse.smu.edu.sg?subject=Password Reset Request&body=Hello%2C%20please%20assist%20me%20with%20a%20password%20reset." className="block text-steel-300 hover:text-steel-100 underline-offset-2 hover:underline">
                Forgot your password?
              </a>
              <a href="mailto:mhaung.2021@mse.smu.edu.sg?subject=Password Change Request&body=Hello%2C%20I%20would%20like%20to%20change%20my%20account%20password." className="block text-steel-300 hover:text-steel-100 underline-offset-2 hover:underline">
        ...
        <div className="hidden md:block relative w-1/2 overflow-hidden h-full mt-0 pt-0">
          <img
            src="/images/room.png"
